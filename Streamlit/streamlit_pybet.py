...
X_train_cat_encod1 = pd.DataFrame(np.array(oneh.fit_transform(X_train_cat1)), index=X_train.index, columns = oneh.get_feature_names())
X_test_cat_encod1 = pd.DataFrame(np.array(oneh.transform(X_test_cat1)), index=X_test.index, columns = oneh.get_feature_names())
